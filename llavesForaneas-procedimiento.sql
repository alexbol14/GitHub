...
EXEC SP_Prueba1
GO
CREATE PROC SP_Anfrage_adresse
@Schueler as varchar(15)
AS
SELECT nachname_schueler, vorname_schueler, adresse_schueler FROM schueler where id_schueler=@Schueler;
GO
EXEC SP_Anfrage_adresse '756734'
